...
public interface Robot {
	...
	public static class State implements View {
		...
		public List<Robot.View> getRobots() {
			...
			List<Robot.View> list = new ArrayList<>();
			for (State s: battle.getStates()) {
				list.add(new State(s.getBattle(), s.getController(), s.getRange(), s.getPosition(), s.getStrength()));
			}
			return list;
		}
		...
		/**
		 * Get the view associated with this state.
		 * 
		 * @return
		 */
		public Robot.View getView() {
			return this;
		}
