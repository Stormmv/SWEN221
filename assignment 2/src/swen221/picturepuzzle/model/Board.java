...
public class Board {
	 ...
	 *                  hexadecimal color, high 8 bits for red, middle 8 bits for
	 *                  green,
	 *                  low 8 bits for blue.
	 *
	 * @param width
	 ...
	 *                                  if the image is empty or, if cells.length is
	 *                                  not a non-null positive
	 *                                  integer or, if the image is not divisible by
	 *                                  width or, if the
	 *                                  number of cells is larger than the number of
	 *                                  pixels or, if the
	 *                                  image is not square or, if the number of
	 *                                  cells is not a perfect
	 *                                  square number.
	 */
	...
	public void swap(Location l1, Location l2) {
		// id1 is the index of the first cell
		int id1 = (l1.row * dimension) + l1.col;
		// id2 is the index of the second cell
