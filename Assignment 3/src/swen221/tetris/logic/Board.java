 ...
 * It is represented as a list of row 20, where every row is a list of column
 * 10.
...
public class Board {
  ...
  private final ArrayList<ArrayList<Color>> inner = new ArrayList<>(rangeY().map(i -> newRow()).toList());
   ...
   */
  public static boolean xOk(int x) {
    return x >= 0 && x < 10;
  }
   ...
   */
  public static boolean yOk(int y) {
    return y >= 0 && y < 20;
  }
